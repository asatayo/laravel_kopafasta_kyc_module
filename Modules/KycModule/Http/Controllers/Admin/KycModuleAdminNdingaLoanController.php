...
class KycModuleAdminNdingaLoanController extends Controller
{
  ...
  public function categories()
  {
      ...
      return view('kycmodule::admin.pending.ndinga.categories', compact('categories'));
  }
  ...
  public function ndinga()
  {
    ...
    $admin =   Auth::guard('admin')->user();
      ...
      return view('kycmodule::admin.pending.ndinga.ndinga', compact('ndingaLoans'));
  }
  ...
  public function review($ndingaLoanId)
  {
    ...
    $admin =   Auth::guard('admin')->user();
      ...
      return view('kycmodule::admin.pending.ndinga.review-ndinga', compact('ndingaLoan', 'pending_reviews'));
  }
  ...
  public function more($ndingaLoanId)
  {
      ...
      return view('kycmodule::admin.pending.ndinga.ndinga-more', compact('ndingaLoan','pending_reviews'));
  }
       ...
       $admin =   Auth::guard('admin')->user();
        ...
        if(!$request->is_accepted){
          ...
          if(!NdingaReview::where('ndinga_id', $ndingaLoan->id)->where('is_reviewed',0)->exists()){
              ...
              $ndingaLoan->is_accepted = 1;
              $ndingaLoan->is_completed = 1;
              $ndingaLoan->save();
          }
        }
