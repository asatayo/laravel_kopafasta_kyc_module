  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top top-bar">
    <div class="container-fluid row">
             ...
             <div class="col-xs-4 col-sm-4 col-md-4">
                <img src="{{asset('modules/kycmodule/img/logo-h.png')}}" class="ms-5" height="50px" alt="">
             </div>
             <div class="col-xs-12 col-sm-12 col-md-4  text-center d-none d-md-block">
                <h1>MIKOPO ILIYOOMBWA</h1>
             </div>
