  ...
  <div class="card">
      <div class="card-body">
          ...
          <div class="row">
            ...
            @if ($mtajipapLoan->is_bottom_reviewed)
            ...
            <div class="col-md-6">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <button type="submit"  class="float-end btn btn-success block"/>{{$mtajipapLoan->is_reviewed? 'Tuma tena': 'Tuma'}} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                                 </div>
                            </div>
                        </div>
              ...
              @else
                <div class="col-md-12 p-2">
                  <div class="alert alert-warning" role="alert"><strong>Taarifa</strong><br>Samahani, msimamizi wa hatua ya nyuma hajafanya mapitio na kupitisha bado, tafadhali wasialiana na mpitiaji <i>{{$mtajipapLoan->reviewer_name->name}}</i></div>
                </div>
              @endif
          </div>
