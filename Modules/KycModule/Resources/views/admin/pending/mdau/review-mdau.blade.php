                ...
                <div id="cardCollpase4" class="collapse show">
                    <div class="table-responsive pt-3">
                        <table class="table table-centered table-nowrap table-borderless mb-0">
                            ...
                            <tbody>
                                @foreach($mdauLoan->other_debts as $key => $debt)
                                 <tr>
             ...
             <div id="cardCollpase4" class="collapse show">
                 <div class="table-responsive pt-3">
                     <table class="table table-centered table-nowrap table-borderless mb-0">
                         ...
                         <tbody>
                           <tbody>
                             @foreach($mdauLoan->guarators as $key => $guarator)
                             <tr>
                               <th scope="row">{{ $key+1 }}</th>
  ...
  <div class="card">
      <div class="card-body">
          ...
          <div class="row">
            ...
            @if ($mdauLoan->is_bottom_reviewed)
            ...
            <div class="col-md-6">
              <table class="table table-bordered">
                 ...
                 <tbody>
                   @foreach($mdauLoan->reviews as $key => $review)
                   <tr>
                     <th scope="row">{{ $key+1 }}</th>
                     <td>{{$review->review}}</td>
              ...
              <div class="col-md-6 mx-0 px-5">
                ...
                <form id="msform" class="form" method="POST" action="{{route('mdauReview')}}">
                  @csrf
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <button type="submit"  class="float-end btn btn-success block"/>{{$mdauLoan->is_reviewed? 'Tuma tena': 'Tuma'}} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                                 </div>
                            </div>
                        </div>
              ...
              @if($mdauLoan->is_completed)
                ...
                @else
                  <div class="col-md-12 p-2">
                    <div class="alert alert-warning" role="alert"><strong>Taarifa</strong><br>Samahani, kwa sasa hatua hii inafanyiwa kazi na msimamizi mwingine, hutoweza kubadili taarifa hii tafadhali wasiliana na msimizi <i><strong>{{$mdauLoan->reviewer_name->name}}</strong></i></div>
                  </div>
                @endif
