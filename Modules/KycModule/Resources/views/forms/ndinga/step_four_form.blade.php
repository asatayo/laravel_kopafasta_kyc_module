              ...
              <h6>SOMA KWA MAKINI MAELEKEZO YANAYOHUSU UJAZAJI WA FOMU HII YALIYOAMBATANISHWA</h6>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" class="form" method="POST" action="{{route('ndingaLoanFour')}}">
                          @csrf
                          <input type="hidden" name="ndinga" value="{{$ndingaLoan->id}}">
                            ...
                            <ul id="progressbar">
                                ...
                                <li class="active" id="vehice-form"><strong>Taarifa muhimu za gari</strong></li>
                            </ul>
                            <!-- fieldsets -->
                                       ...
                                       <div class="col-md-4">
                                         <div class="form-group">
                                           <label for="vehicle_type" class="text-black">Aina ya gari*</label>
                                             <input type="text"  class="form-control form-control-lg" value="{{$ndingaLoan->vehicle_type}}" name="vehicle_type" placeholder="Aina ya gari"/>
                                       ...
                                       <div class="col-md-4">
                                         <div class="form-group">
                                           <label for="vehicle_name" class="text-black">Jina kamili linalosomeka kwenye kadi gari*</label>
                                             <input type="text"  class="form-control form-control-lg"  value="{{$ndingaLoan->vehicle_name}}" name="vehicle_name" placeholder="Jina kamili linalosomeka kwenye kadi gari"/>
                                         </div>
                                       </div>
                                       ...
                                       <div class="col-md-4">
                                         <div class="form-group">
                                           <label for="vehicle_registration_number" class="text-black">Namba ya usajili*</label>
                                             <input type="text"  class="form-control form-control-lg" value="{{$ndingaLoan->vehicle_registration_number}}" name="vehicle_registration_number" placeholder="Namba ya usajili"/>
                                         </div>
                                       </div>
                                    </div>
                              ...
                              <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="vehicle_chassis_number" class="text-black">Namba ya chasis*</label>
                                      <input type="text"  class="form-control form-control-lg" name="vehicle_chassis_number" value="{{$ndingaLoan->vehicle_chassis_number}}"  placeholder="Namba ya chasis"/>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="vehicle_color" class="text-black">Rangi ya gari*</label>
                                      <input type="text"  class="form-control form-control-lg" value="{{$ndingaLoan->vehicle_color}}" name="vehicle_color" placeholder="Rangi ya gari"/>
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label for="vehicle_model" class="text-black">Modeli*</label>
                                    <input type="text"  class="form-control form-control-lg" value="{{$ndingaLoan->vehicle_model}}" name="vehicle_model" placeholder="Modeli"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="vehicle_insurance" class="text-black">Aina ya Bima*</label>
                                            <input type="text"  class="form-control form-control-lg" value="{{$ndingaLoan->vehicle_insurance_type}}" name="vehicle_insurance_type" placeholder="Aina ya Bima"/>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="vehicle_insurance_provider" class="text-black">Jina la mtoa Bima*</label>
                                            <input type="text"  class="form-control form-control-lg" name="vehicle_insurance_provider" value="{{$ndingaLoan->vehicle_insurance_provider}}" placeholder="Jina la mtoa Bima"/>
