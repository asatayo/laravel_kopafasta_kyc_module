              ...
              <h6>SOMA KWA MAKINI MAELEKEZO YANAYOHUSU UJAZAJI WA FOMU HII YALIYOAMBATANISHWA</h6>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" class="form" method="POST" action="{{route('ndingaLoanOne')}}">
                          @csrf
                          <input type="hidden" name="ndinga" value="{{ $ndingaLoan->id }}">
                            <!-- progressbar -->
                            <ul id="progressbar">
                                ...
                                <div class="form-card">
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label for="amount" class="text-black">Kiasi*</label>
                                              <input type="text" onkeyup="formatNumber('amount')" class="form-control form-control-lg amount" name="amount" value="{{ !empty($ndingaLoan->amount)?number_format($ndingaLoan->amount) : ''}}" placeholder="Kiasi"/>
                                        ...
                                        <div class="col-md-8">
                                          <div class="form-group mb-4">
                                            <label for="amount_words" class="text-black ps-1 mb-1">Kiasi cha mkopo kinachoombwa (Kwa maneno)*</label>
                                              <textarea  class="form-control" name="amount_words" rows="4" placeholder="Kiasi kwa maneno"/>{{ !empty($ndingaLoan->amount_words)?$ndingaLoan->amount_words : ''}}</textarea>
                                    ...
                                    <div class="row">
                                      <div class="form-group mb-4">
                                        <label for="intension" class="text-black">Lengo la mkopo</label>
                                          <textarea  class="form-control" name="intension" placeholder="Lengo la mkopo"/>{{ !empty($ndingaLoan->intension)?$ndingaLoan->intension : ''}}</textarea>
                                       ...
                                       <div class="col-md-6">
                                         <div class="form-group">
                                           <label for="work_business" class="text-black">Kazi/Biashara</label>
                                             <input type="text"  class="form-control form-control-lg" name="work_business" value="{{ !empty($ndingaLoan->work_business)?$ndingaLoan->work_business : ''}}" placeholder="Kazi/Biashara"/>
                                       ...
                                       <div class="col-md-6">
                                         <div class="form-group">
                                           <label for="dependants_count" class="text-black">Idadi ya wategemezi</label>
                                             <input type="number"  class="form-control form-control-lg" name="dependants_count" value="{{ !empty($ndingaLoan->dependants_count)?$ndingaLoan->dependants_count : ''}}" placeholder="Idadi ya wategemezi"/>
                                       ...
                                       <div class="col-md-3">
                                         <div class="form-group">
                                           <label for="income_perday" class="text-black">Kipato cha sasa (kwa siku)</label>
                                             <input type="text"  class="form-control form-control-lg" name="income_perday" value="{{ !empty($ndingaLoan->income_perday)?$ndingaLoan->income_perday : ''}}" placeholder="Kipato kwa siku"/>
                                       ...
                                       <div class="col-md-3">
                                         <div class="form-group">
                                           <label for="income_perweek" class="text-black">Kipato cha sasa (kwa wiki)</label>
                                             <input type="text"  class="form-control form-control-lg" name="income_perweek" value="{{ !empty($ndingaLoan->income_perweek)?$ndingaLoan->income_perweek : ''}}" placeholder="Kipato cha sasa (kwa wiki)"/>
                                       ...
                                       <div class="col-md-3">
                                         <div class="form-group">
                                           <label for="income_permonth" class="text-black">Kipato cha sasa (kwa mwezi)</label>
                                             <input type="text"  class="form-control form-control-lg" name="income_permonth" value="{{ !empty($ndingaLoan->income_permonth)?$ndingaLoan->income_permonth : ''}}" placeholder="Kipato cha sasa (kwa mwezi)"/>
                                       ...
                                       <div class="col-md-3">
                                         <div class="form-group">
                                           <label for="income_peryear" class="text-black">Kipato cha sasa (kwa mwaka)</label>
                                             <input type="text"  class="form-control form-control-lg" name="income_peryear" value="{{ !empty($ndingaLoan->income_permonth)?$ndingaLoan->income_permonth : ''}}" placeholder="Kipato cha sasa (kwa mwaka)"/>
                                    ...
                                    <div class="form-group mb-4">
                                      <label for="other_properties" class="text-black">Mali nyinginezo</label>
                                        <textarea  class="form-control" name="other_properties" placeholder="Mali nyinginezo"/>{{ !empty($ndingaLoan->other_properties)?$ndingaLoan->other_properties : ''}}</textarea>
