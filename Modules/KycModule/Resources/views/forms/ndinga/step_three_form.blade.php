              ...
              <h6>SOMA KWA MAKINI MAELEKEZO YANAYOHUSU UJAZAJI WA FOMU HII YALIYOAMBATANISHWA</h6>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" class="form" method="POST" action="{{route('ndingaLoanThree')}}">
                          @csrf
                      ...
                      <div class="row mb-4">
                          <div class="col-3">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     ...
                                     <td> <a class="btn btn-danger float-end me-5" href="{{url('kycmodule/loan/ndinga/guarator-delete', [$ndingaLoan->id,$guarator->id])}}">Delete</a> </td>
                            ...
                            <a href="{{ url('kycmodule/loan/ndinga',[$ndingaLoan->id, 'step-four']) }}"  class="float-end btn btn-success me-md-5"/> Hakiki na Hifadhi <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
