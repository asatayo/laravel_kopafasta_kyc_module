...
<p>(i) Mkopo mkuu, ambao unaanzia Tshs. 30,000/= hadi 200,000/=, utarejeshwa katika kipindi cha mwezi mmora tangu tarene uliootolewa. (kwa mrano: Kama umechukua tarene 10
    ...
    <a href="{{ url('kycmodule/loan/mtajipap', [$mtajipapLoan->id, 'finish']) }}"  class="float-end btn btn-success me-md-5"/> Mbele <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
</div>
