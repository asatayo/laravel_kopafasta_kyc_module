                                        ...
                                        <div class="col-md-6 offset-md-3 px-5">
                                          <div class="form-group mb-1 form-message">
                                           ...
                                           <div class="form-group mb-4">
                                             <select class="form-select form-select-lg" name="loan">
                                                  <option selected disabled>Chagua aina ya mkopo</option>
                                                  <option value="MKOPO WA NDINGA">MKOPO WA NDINGA</option>
                                                  <option value="MKOPO WA MTAJIPAP">MKOPO WA MTAJIPAP!</option>
                                                  <option value="MKOPO WA WATUMISHI WA UMA">MKOPO WA WATUMISHI WA UMA</option>
                                             </select>
                                               <small class="fw-bold loan_error"></small>
                                           </div>
